...
\begin{figure}[!htb]
	\centering
	\subfloat[a]{
		\includegraphics[width=4.2cm]{Figuras/updraft_gasifier}
		\label{figdroopy}
	}
	\quad %espaco separador
	\subfloat[b]{
		\includegraphics[width=4.2cm]{Figuras/downdraft_gasifier}
		\label{figsnoop}
	}
	\subfloat[c]{
	\includegraphics[width=4.5cm]{Figuras/crossdraft_gasifier}
}
...
\begin{figure}[!htb]
	\centering
	\subfloat[a]{
		\includegraphics[width=5.5cm]{Figuras/fluidized_bed}
	}
	\quad %espaco separador
	\subfloat[b]{
		\includegraphics[width=5cm]{Figuras/entrained_flow}
	}
